...
interface CreatedPostAndComponents {
    post: Post;
    components: Component[];
}

interface OldPostFormProps {
    post: NewPost | Post;
...
export function OldPostForm({saveText, post, components: initialComponents, onSaveSuccess, onSaveError}: OldPostFormProps) {
